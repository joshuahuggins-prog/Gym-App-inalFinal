...
const ImportExportPage = () => {
  ...
  // ✅ Match ExercisesPage icon logic (works on GH Pages via PUBLIC_URL)
    ...
    >
      <div className="max-w-2xl mx-auto px-4 py-6 pb-24 space-y-6">
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          {/* ✅ Export button moved here (no action bar now) */}
          <Button onClick={handleExportBackup} size="lg" className="w-full mb-4">
