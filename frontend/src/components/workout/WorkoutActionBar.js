...
export default function WorkoutActionBar({ onSaveFinish, disableFinish = false }) {
  ...
  const sizeClass = collapsed ? "h-16 w-16 rounded-full px-0" : "h-16 w-[220px] rounded-3xl px-6";
  ...
  return (
    <div className={basePos}>
      ...
      >
        ...
        {!collapsed && <span className="text-base font-semibold">Save &amp; Finish Workout</span>}
      </Button>
    </div>
  );
}
